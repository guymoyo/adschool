...
privileged aspect EtablissementController_Roo_Controller {
    ...
    public String EtablissementController.createForm(Model uiModel) {
        uiModel.addAttribute("etablissement", new Etablissement());
    ...
    public String EtablissementController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("etablissements", Etablissement.findEtablissementEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
    ...
    public Collection<Division> EtablissementController.populateDivisions() {
        return Arrays.asList(Division.class.getEnumConstants());
    }
    
    @ModelAttribute("etablissements")
    public Collection<Etablissement> EtablissementController.populateEtablissements() {
        return Etablissement.findAllEtablissements();
    }
    
    @ModelAttribute("typeetablissements")
    public Collection<TypeEtablissement> EtablissementController.populateTypeEtablissements() {
        return Arrays.asList(TypeEtablissement.class.getEnumConstants());
    }
